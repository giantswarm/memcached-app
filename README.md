...
Giant Swarm offers a memcached App which can be installed in workload clusters.
Here we define the memcached chart with its templates and default configuration.
